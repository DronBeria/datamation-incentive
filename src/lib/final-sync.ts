...
async function fullSync() {
  ...
  try {
    ...
    // 4. Reset Users
    const users = [
      { email: 'admin@company.com', password_hash: hash, full_name: 'Rajesh Kumar (Admin)', role_id: roleMap['admin'], department: 'Executive', is_active: true },
    ...
    console.log('🔑 Password Verified for all: password123');
