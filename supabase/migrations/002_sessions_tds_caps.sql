...
-- Seed default TDS settings (INSERT IF NOT EXISTS via ON CONFLICT DO NOTHING)
...
-- Lightweight log of automated job runs
-- ────────────────────────────────────────────────────────────
...
CREATE TABLE IF NOT EXISTS public.report_schedules (
  ...
  day_of_week INTEGER DEFAULT 1,               -- 0=Sun…6=Sat (for weekly)
...
-- Seed a default weekly Monday report
